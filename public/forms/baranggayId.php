        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6" style="min-width: 500px">
                <div class="card shadow-lg position-relative">
                    <div class="card-body">
                        <h2 class="text-center mb-4 service-form-title text-success">BARANGGAY ID APPLICATION</h2>

                        <!-- Hidden Input Fields -->
                        <input type="hidden" name="type" value="baranggay-clearance">
                        <input type="hidden" name="bg-name" value="Baranggay ID">
                        ...
                        <div class="form-group mb-3">
                            <label for="purpose" class="form-label">Purpose of ID:</label>
